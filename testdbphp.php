...
<body>
<h2>INET 4031 Systems Lab 7</h2>

<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'noah7', 'noah7', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date FROM employees where last_name = 'Baaz'";
